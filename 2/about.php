            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>uas basis data</b></center></h1>
					<center><img src="../aset/foto/ids.jpg" width="225" height="225" /></center>
					<center><h2><b>uas basis data &copy;  <?php echo date ('Y') ?></b></h2></center>
					<center><h4><b>Made with <strong><i class="fa fa-code"></i></strong> and <i class="fa fa-heart"></i>Rahmat hasibuan </b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
