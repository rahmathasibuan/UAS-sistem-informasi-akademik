...
<html>
 <head>
    <meta charset="utf-8">
    <title>Uas Sistem Basis Data</title>
	<!-- Library CSS -->
	<?php
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>Uas Sistem Basis Data</b></center></h1>
					<center><img src="../aset/foto/pb.png" width="225" height="225" /></center>
         <center> <h1> INI ADALAH PROJECT UAS SISTEM BASIS DATA</h1></center>
          <center><h2> Nama: Dollar Rahmat Hasibuan</h2></center>
          <center><h2> NIM : 311910026</h2></center>
          <center> <h2> Kelas : TI.19.B2</h2></center>
                </div><!-- /.box-header -->
                <div class="box-body">
